...
export const USER_PROPERTY_SCHEMA: PropertyMetadata[] = [
  ...
  },
  {
    ...
    handledBy: 'optionB',
    peopleDataLabel: 'personInterests',
  ...
  },
  {
    ...
    writable: true,
    category: 'personal',
    graphPath: 'educationalActivities',
    description: 'Educational activities including degrees, programs, and courses',
    handledBy: 'optionB',
    peopleDataLabel: 'personEducationalActivities',
    profileApiEndpoint: '/profile/educationalActivities',
  },
  {
    name: 'publications',
    ...
    writable: true,
    category: 'personal',
    graphPath: 'publications',
    description: 'Publications authored by the user',
    handledBy: 'optionB',
    peopleDataLabel: 'personPublications',
    profileApiEndpoint: '/profile/publications',
  },
  {
    name: 'patents',
    type: 'array',
    ...
    category: 'personal',
    graphPath: 'patents',
    description: 'Patents held by the user',
    handledBy: 'optionB',
    peopleDataLabel: 'personPatents',
    profileApiEndpoint: '/profile/patents',
  },
  {
    name: 'projects',
    type: 'array',
  ...
  },
  {
    ...
    handledBy: 'optionB',
    peopleDataLabel: 'personLanguages',
