...
Only Option A properties are tested here. Option B enrichment fields (skills, interests, aboutMe, languages, etc.)
are handled by the connector pipeline and should not be validated in this plan.
...
**Expected Results**:
- ✅ All 3 users created
- ✅ Fax number stored correctly
- ✅ OtherMails stored as array
...
**Goal**: Modify Option A array and string properties on existing users
...
**Goal**: Test emptying Option A array and string properties
...
### ❌ Incorrect Formats
```csv
otherMails,test@gmail.com,test@outlook.com          # Wrong - would be 3 separate columns
otherMails,"test@gmail.com,test@outlook.com"        # Wrong - comma-separated string
otherMails,"['test@gmail.com''test@outlook.com']"   # Wrong - missing commas
```
...
- Number of array items (e.g., max 50 emails?)
- String length per array item
- Total property size

**To Test**: Add 100+ items to otherMails array and see what happens
...
Option A does not manage personal enrichment fields (skills, interests, aboutMe, languages). Those are handled by Option B.

## Success Criteria

### Must Pass
- ✅ All 3 test users created without errors
- ✅ Array property (otherMails) stored as array
- ✅ Fax number stored correctly
- ✅ preferredDataLocation stored when license permits
...
- Status: ✅ PASS / ❌ FAIL
- Users Created: X/3
- Properties Set: X/3 Option A properties
- Errors: [list any errors]
- Notes: [observations]

### Test 2: Array Properties
- otherMails: ✅ Stored as array / ❌ Stored as string / ❌ Failed
